...
public class Registry {
	...
	private ArrayList<SMS> listOfSMS=new ArrayList<SMS>();
	...
	boolean flag=true;
		...
		for(Communication x: Comms)
		{
			...
			if(x.num1.equals(number1) && x.num2.equals(number2) && flag && x.getDuration()>0)
			{
				max=x.getDuration();
				MaxPhoneCall=(PhoneCall)x;
				flag=false;
			}
			if(x.num1.equals(number1) && x.num2.equals(number2) && x.getDuration()>=max)
			{
				max=x.getDuration();
				MaxPhoneCall=(PhoneCall)x;
			}
	...
	public ArrayList<SMS> getMessagesBetween(String number1,String number2)
	{
		...
		for(Communication x: Comms)
		{
			if(x.num1.equals(number1) &&x.num2.equals(number2))
            { 
